...
(function() {
    ...
    function initMobileMenu() {
        ...
        function openMobileMenu() {
            ...
            mobileMenuOverlay.classList.add('mobile_menu_overlay_on');
        ...
        function closeMobileMenu() {
            ...
            mobileMenuOverlay.classList.remove('mobile_menu_overlay_on');
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape' && mobileMenuWrap.classList.contains('mobile_menu_on')) {
                closeMobileMenu();
            }
        });
        ...
        window.addEventListener('resize', function() {
            if (window.innerWidth > 991 && mobileMenuWrap.classList.contains('mobile_menu_on')) {
                closeMobileMenu();
            }
        });
